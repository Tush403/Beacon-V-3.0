...
import { Sheet, SheetContent as SheetContentPrimitive, SheetTitle } from "@/components/ui/sheet" // Renamed to avoid conflict
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContentPrimitive
            ...
            side={side}
          >
            <SheetTitle className="sr-only">Filters and Tools</SheetTitle>
