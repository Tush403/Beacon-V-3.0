...
export const toolLogos: Record<string, string> = {
  ...
  'mabl': '/logos/Mabl.png',
  'micro focus uft one': '/logos/Micro Focus UFT One.png',
  ...
  'ranorex studio': '/logos/Ranorex.png',
  'reflect': '/logos/Reflect.png',
  'rest assured': '/logos/Rest Assured.png',
  'robot framework': '/logos/Robot Framework.png',
  'sahi pro': '/logos/Sahi Pro.png',
  'sauce labs': '/logos/Sauce Labs.png',
  'selenium': '/logos/Selenium.png',
  'soapui': '/logos/SoapUI.png',
  'specflow': '/logos/SpecFlow.png',
  'testcafe': '/logos/TestCafe.png',
  'testcomplete': '/logos/TestComplete.png',
  'testim': '/logos/Testim.png',
  'testsigma': '/logos/TestSigma.png',
  'tricentis tosca': '/logos/Tricentis Tosca.png',
  'webdriverio': '/logos/WebdriverIO.png',
  'winappdriver': '/logos/WinAppDriver.png',
  'xcuitest': '/logos/XCUITest.png',
  'zeta automation': '/logos/ZeTA Automation.png',
};
